...
export function NewTimelineEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): NewTimelineEntry {
    if (json == null) {
        return json;
    }
    return {
...
export function NewTimelineEntryToJSONTyped(value?: NewTimelineEntry | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
