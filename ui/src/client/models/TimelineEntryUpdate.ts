...
export function TimelineEntryUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimelineEntryUpdate {
    if (json == null) {
        return json;
    }
    return {
...
export function TimelineEntryUpdateToJSONTyped(value?: TimelineEntryUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
