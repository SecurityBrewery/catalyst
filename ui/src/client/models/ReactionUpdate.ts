...
export function ReactionUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactionUpdate {
    if (json == null) {
        return json;
    }
    return {
...
export function ReactionUpdateToJSONTyped(value?: ReactionUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
