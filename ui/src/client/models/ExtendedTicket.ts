...
export function ExtendedTicketFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtendedTicket {
    if (json == null) {
        return json;
    }
    return {
...
export function ExtendedTicketToJSONTyped(value?: ExtendedTicket | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
