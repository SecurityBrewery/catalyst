...
func NewStorage(key *rsa.PrivateKey, users map[string]*user.User, clients map[string]*Client, services map[string]Service) *Storage {
	return &Storage{
...
func (s *Storage) RegisterClients(client *Client) {
